...
class CalcPresenter {
    ...
    private static final int OPERATION_PARENTHESES_RIGHT = 4;
    private static final int OPERATION_PARENTHESES_LEFT = 5;
    private static final int OPERATION_FACTORIAL = 6;
    private static final int OPERATION_PI = 7;
    private static final int OPERATION_SHIFT = 8;
    private static final int OPERATION_SQUARE = 9;
    private static final int OPERATION_POWER = 10;
    private static final int OPERATION_SIN = 12;
    private static final int OPERATION_COS = 12;
    private static final int OPERATION_TAN = 13;
    private static final int OPERATION_SQRT = 14;
    private static final int OPERATION_POWER_OF_TEN = 15;
    private static final int OPERATION_LOG = 16;
    private static final int OPERATION_EXP = 17;
    private static final int OPERATION_MOD = 18;
    private static final int OPERATION_CUBE = 19;
    private static final int OPERATION_ROOT = 20;
    private static final int OPERATION_SIN_1 = 21;
    private static final int OPERATION_COS_1 = 22;
    private static final int OPERATION_TAN_1 = 23;
    private static final int OPERATION_REVERSE = 24;
    private static final int OPERATION_POWER_OF_EXP = 25;
